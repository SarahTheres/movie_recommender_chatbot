...
var _botpress = __webpack_require__(22);
...
module.exports = function (knex, config) {
  var checkConversation = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(conversationId, userId) {
      var knownUserId, convo;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              knownUserId = knownConvosCache.get(conversationId);
            ...
            case 7:
              _context.next = 9;
              return knex('web_conversations').where({ id: conversationId, userId: userId }).select('id').limit(1).then().get(0);
    ...
    return function checkConversation(_x, _x2) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              _context2.next = 6;
              return knex('users').where({ platform: 'webchat', userId: userId }).then().get(0);
  ...
  var appendUserMessage = function () {
    var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(userId, conversationId, _ref4) {
      var type = _ref4.type,
          text = _ref4.text,
          raw = _ref4.raw,
          data = _ref4.data;
      var message, shouldUpdateLastHeard;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return checkConversation(conversationId, userId);
            ...
            case 7:
              ...
              message = (0, _context3.t0)(_context3.t1, _context3.t2, _context3.t3);
              shouldUpdateLastHeard = userInitiatedMessageTypes.includes(type.toLowerCase());

              // PERF: message insertion is a serious bottlenecks
              // consider implementing in-memory batching queue
              // similar to logs

              return _context3.abrupt('return', _bluebird2.default.join(knex('web_messages').insert(message).then(), shouldUpdateLastHeard && bumpLastHeardOn(conversationId)(), function () {
    ...
    return function appendUserMessage(_x4, _x5, _x6) {
      return _ref3.apply(this, arguments);
    };
  }();

  var appendBotMessage = function () {
    var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(botName, botAvatar, conversationId, _ref6) {
      var type = _ref6.type,
          text = _ref6.text,
          raw = _ref6.raw,
          data = _ref6.data;
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 3:
              return _context4.abrupt('return', _extends({}, message, {
                sent_on: new Date(),
                message_raw: raw,
                message_data: data
              }));
    ...
    return function appendBotMessage(_x7, _x8, _x9, _x10) {
  ...
  var patchConversation = function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return knex('web_conversations').where({ id: conversationId, userId: userId }).update({
                title: title,
    ...
    return function patchConversation(_x12, _x13, _x14, _x15, _x16) {
  ...
  var getOrCreateRecentConversation = function () {
    var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(userId) {
      var _ref10 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          ignoreLifetimeExpiry = _ref10.ignoreLifetimeExpiry,
          originatesFromUserMessage = _ref10.originatesFromUserMessage;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return knex('web_conversations').select('id', 'last_heard_on').whereNotNull('last_heard_on').andWhere({ userId: userId }).andWhere(recentCondition || {}).orderBy('last_heard_on', 'desc').limit(1).then().get(0);

            case 4:
              conversation = _context6.sent;

              if (!(conversation && (0, _moment2.default)(conversation.last_heard_on).add(RECENT_CONVERSATION_LIFETIME, 'ms').isAfter())) {
                _context6.next = 7;
                break;
              }

              return _context6.abrupt('return', conversation.id);

            case 7:
              return _context6.abrupt('return', createConversation(userId, { originatesFromUserMessage: originatesFromUserMessage }));
    ...
    return function getOrCreateRecentConversation(_x17) {
      return _ref9.apply(this, arguments);
    };
  }();

  var listConversations = function () {
    var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(userId) {
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return knex('web_conversations').select('id').where({ userId: userId }).orderBy('last_heard_on', 'desc').limit(RECENT_CONVERSATIONS_LIMIT).then();
    ...
    return function listConversations(_x19) {
      return _ref11.apply(this, arguments);
    };
  }();

  var getConversation = function () {
    var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(userId, conversationId) {
          ...
          switch (_context8.prev = _context8.next) {
            ...
            case 10:
              ...
              return _context8.abrupt('return', Object.assign({}, conversation, {
                messages: (0, _lodash.orderBy)(messages, ['sent_on'], ['asc'])
              }));
    ...
    return function getConversation(_x20, _x21) {
  ...
  var RECENT_CONVERSATIONS_LIMIT = 100;
  var USER_INFO_CACHE_TTL = (0, _ms2.default)('1 minute');
  var USER_INFO_CACHE_SIZE = 1000;
  var KNOWN_CONVOS_CACHE_SIZE = 1000;

  var h = (0, _botpress.DatabaseHelpers)(knex);
  var isLite = function isLite() {
    return h.isLite();
  };

  var userInfoCache = (0, _lruCache2.default)({
    maxAge: USER_INFO_CACHE_TTL,
    max: USER_INFO_CACHE_SIZE
  });

  var knownConvosCache = (0, _lruCache2.default)(KNOWN_CONVOS_CACHE_SIZE);
  ...
  function initialize() {
    ...
    var createIndex = function createIndex(tableName) {
      for (var _len = arguments.length, index = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        index[_key - 1] = arguments[_key];
      }

      return knex.schema.alterTable(tableName, function (table) {
        table.index.apply(table, index);
      }).catch(function (err) {
    ...
    return h.createTableIfNotExists('web_conversations', function (table) {
      ...
      return createIndex('web_conversations', 'userId');
    }).then(function () {
      return createIndex('web_conversations', ['id', 'userId']);
    }).then(function () {
      return createIndex('web_conversations', ['userId', knex.raw('last_heard_on DESC')]);
    }).then(function () {
      return h.createTableIfNotExists('web_messages', function (table) {
  ...
  var bumpLastHeardOn = (0, _lodash.memoize)(function (conversationId) {
    return (0, _lodash.throttle)(function () {
      return knex('web_conversations').where('id', conversationId).update({ last_heard_on: h.date.now() }).then();
    }, 50);
  });

  var createConversation = function createConversation(userId) {
    var _ref7 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        originatesFromUserMessage = _ref7.originatesFromUserMessage;

    userId = (0, _util.sanitizeUserId)(userId);

    var uid = Math.random().toString().substr(2, 6);
    var title = 'Conversation ' + uid;
...
var USERS_CACHE_SIZE = 1000;
var USERS_CACHE_TTL = (0, _ms2.default)('10 minutes');

module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(bp) {
    ...
    var knex, knownUsersCache, createNewUser, getOrCreateUser, ensureUserExists;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
          ...
          case 2:
            knex = _context4.sent;
            knownUsersCache = (0, _lruCache2.default)({
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        user = knownUsersCache.get(userId);
            ...
            ensureUserExists = function () {
              var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(userId) {
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
              ...
              return function ensureUserExists(_x4) {
                return _ref4.apply(this, arguments);
              };
            }();

            return _context4.abrupt('return', { getOrCreateUser: getOrCreateUser, getUserProfile: getUserProfile, ensureUserExists: ensureUserExists });
...
var _umm = __webpack_require__(11);
...
var _multerS = __webpack_require__(16);
...
var _inject3 = __webpack_require__(19);

var _inject4 = _interopRequireDefault(_inject3);

var _serveStatic = __webpack_require__(20);
...
var VALID_USER_ID_RE = /^[a-z0-9-_~]+$/i;
...
module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(bp, config) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                ...
                message = (0, _context6.t0)(_context6.t1, _context6.t2, _context6.t3);
              ...
              case 25:
                ...
                throw new Error('Error while decrypting payload', _context6.t4);
              ...
              case 38:
                return _context6.abrupt('return', (_bp$middlewares = bp.middlewares).sendIncoming.apply(_bp$middlewares, [{
                  platform: 'webchat',
                  type: payload.type,
                  user: user,
    ...
    var diskStorage, upload, awsConfig, s3, s3Storage, knex, _db, listConversations, getConversation, appendUserMessage, getOrCreateRecentConversation, createConversation, _ref2, getOrCreateUser, getUserProfile, ensureUserExists, router, asyncApi, pkg, modulePath, staticFolder, validateUserId, getMessageContent, convertToTxtFile;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 9:
            ...
            ensureUserExists = _ref2.ensureUserExists;
            ...
            router.get('/conversations/:userId/:conversationId', function () {
              var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(req, res) {
                var _ref11, userId, conversationId;
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 6:
                        ...
                        return _context4.abrupt('return', _context4.t0.send.call(_context4.t0, _context4.t1));
            ...
            validateUserId = function validateUserId(userId) {
              return VALID_USER_ID_RE.test(userId);
            };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                socketId = (0, _util.sanitizeUserId)(user.userId);
